...
#test = "  影响温州机场的对流云团已经移出本场，取消21日19:11发布的07号机场警报（雷暴）。 "
#print (extract_cancel(test))
